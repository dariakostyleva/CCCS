...
void transmission_check_a2(){
	...
	tree->SetBranchAddress("tpc_y_41",&tpc_y_41);
  	...
  	Float_t id_z1_c1;
  	Float_t id_z1_c2;
  	fileTransmOut.Form("%s_transm_a2.txt",name1);
	...
	TH2F *h_id_cut_tpc = new TH2F("h_id_cut_tpc","h_id_cut_tpc",500,1.5,2.5,500,4,10);
  	...
  	TH1F *h_id_a2 = new TH1F("h_id_a2","h_id_a2",100,-50,50);
  	TH1F *h_id_a2_slice = new TH1F("h_id_a2_slice","h_id_a2_slice",100,-50,50);
			...
			if(id_z1_ch > id_z1_c1 && id_z1_ch < id_z1_c2 &&
			   ...
			   tpc_ang_x_s2 > tpc_cut_c1 && tpc_ang_x_s2 < tpc_cut_c2){
				//tpc_ang_x_s2 > tpc_cut_c1 && tpc_ang_x_s2 < tpc_cut_c2){
					...
					h_z1_ch_cut->Fill(id_z1_ch);
					h_z2_cut->Fill(id_z2);
					h_id_a2_slice->Fill(tpc_ang_x_s2);
			}
		}
