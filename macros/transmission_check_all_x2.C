...
void transmission_check_all_x2(){
	...
	fileTransmOut.Form("%s_transm_all_x2.txt",name1);
	...
	TH2F *h_id_cut_tpc = new TH2F("h_id_cut_tpc","h_id_cut_tpc",500,1.5,2.5,500,4,10);
  	...
  	for (int k = fixed_cut_x2_c1; k <= fixed_cut_x2_c2; k+=5) {
  		tpc_cut_c1 = k;
  		tpc_cut_c2 = k+5;
