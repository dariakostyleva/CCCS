{
//========= Macro generated from object: h_z2_cut/Z2 from MUSIC42, after target, with condition on Z1 and TPC
//========= by ROOT version6.30/04
   ...
   TText *ptstats_LaTex = ptstats->AddText("h_z2_cut");
   ptstats_LaTex->SetTextSize(0.046);
   ptstats_LaTex = ptstats->AddText("Entries = 13264  ");
   ptstats_LaTex = ptstats->AddText("Mean  =  8.374");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.4755");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(0);
   ptstats->Draw();
   h_z2_cut__1->GetListOfFunctions()->Add(ptstats);
   ptstats->SetParent(h_z2_cut__1);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   h_z2_cut__1->SetLineColor(ci);
   h_z2_cut__1->GetXaxis()->SetLabelFont(42);
   h_z2_cut__1->GetXaxis()->SetLabelSize(0.05);
   h_z2_cut__1->GetXaxis()->SetTitleSize(0.05);
   h_z2_cut__1->GetXaxis()->SetTitleOffset(1);
   h_z2_cut__1->GetXaxis()->SetTitleFont(42);
   h_z2_cut__1->GetYaxis()->SetLabelFont(42);
   h_z2_cut__1->GetYaxis()->SetLabelSize(0.05);
   h_z2_cut__1->GetYaxis()->SetTitleSize(0.05);
   h_z2_cut__1->GetYaxis()->SetTitleFont(42);
   h_z2_cut__1->GetZaxis()->SetLabelFont(42);
   h_z2_cut__1->GetZaxis()->SetLabelSize(0.05);
   h_z2_cut__1->GetZaxis()->SetTitleOffset(1);
   h_z2_cut__1->GetZaxis()->SetTitleFont(42);
   h_z2_cut__1->Draw("");
}
