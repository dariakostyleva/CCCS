...
void draw_transm_x2(){
    ...
    const std::string file_out_name = "s533_50_empty_53-54_transm_x2.txt";
    const std::string file_in_name = "s533_50_gC_12mm_46-47_transm_x2.txt";
    ...
    double percentageDifference_limit = 0.4;
    ...
    lc->AddEntry(graph_cccs, "CCCS of 16O in 6 mm gC", "lp");
